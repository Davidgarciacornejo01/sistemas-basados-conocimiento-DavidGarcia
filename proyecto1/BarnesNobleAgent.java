...
public class BarnesNobleAgent extends Agent {
	...
	class Reporte extends OneShotBehaviour{
		...
		public void action() {
			...
			String cadena = barnesNobleDB.getProdutos();
	...
	//aqui inicia lo de clips
	/*
	private class ReceptorComportaminento extends OneShotBehaviour {
		...
		public void action() {
			...
			if (mensaje!= null) {
				...
				//Tell tell=new Tell(objetos[0], objetos[1]);
				addBehaviour(new TellComputadora(objetos[0], objetos[1]));
				addBehaviour(new AskComputadora());
				addBehaviour(new TellCelular(objetos[0], objetos[1]));
				addBehaviour(new AskCelular());
				addBehaviour(new TellSaco(objetos[0], objetos[1]));
				addBehaviour(new AskSaco());
				addBehaviour(new TellZapatos(objetos[0], objetos[1]));
				addBehaviour(new AskZapatos());
				addBehaviour(new TellPantalla(objetos[0], objetos[1]));
				addBehaviour(new AskPantalla());
			}
	...
	private class TellComputadora extends OneShotBehaviour{
		private String tipo;
	...
	private class AskComputadora extends OneShotBehaviour{
	...
	private class TellCelular extends OneShotBehaviour{
		private String tipo;
		private String precio;
	...
	private class AskCelular extends OneShotBehaviour{
	...
	private class TellSaco extends OneShotBehaviour{
		private String tipo;
		private String precio;
	...
	private class AskSaco extends OneShotBehaviour{
	...
	private class TellZapatos extends OneShotBehaviour{
		private String tipo;
		private String precio;
	...
	private class AskZapatos extends OneShotBehaviour{
	...
	private class TellPantalla extends OneShotBehaviour{
		private String tipo;
		private String precio;
	...
	private class AskPantalla extends OneShotBehaviour{
