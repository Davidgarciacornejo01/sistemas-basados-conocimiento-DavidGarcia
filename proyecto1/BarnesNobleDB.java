...
import java.sql.*;
public class BarnesNobleDB {
    // Librería de MySQL
    public String driver = "com.mysql.jdbc.Driver";

    // Nombre de la base de datos
    public String database = "barnes_noble";
    ...
    public String getProdutos() {
        ...
        try {
            ...
            while(resultSet.next()) {
               ...
               /* System.out.println(
                        "nombre: "+resultSet.getObject(1)+"  tipo: "+
                        resultSet.getObject(2)+"  precio: "+
                        resultSet.getObject(3)+"  elementos disponibles: "+
                ...
                //administrador.pasarDatos(object);
            }
            return cadena;
        } catch (SQLException e) {
            // TODO Auto-generated catch block
