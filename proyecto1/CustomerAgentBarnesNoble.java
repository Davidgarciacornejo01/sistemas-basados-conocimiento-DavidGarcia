...
public class CustomerAgentBarnesNoble extends Agent {
			...
			case 3:      
				...
				if (reply != null) {
					...
					if (reply.getPerformative() == ACLMessage.INFORM) {
						...
						String[] arrayElementos = barnesNobleDB.buscarProducto(targetBookTitle);
						int numeroElementos=Integer.parseInt(arrayElementos[4])-1;
						barnesNobleDB.updateProductos(numeroElementos, arrayElementos[0], arrayElementos[2]);
