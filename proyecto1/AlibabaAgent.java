...
public class AlibabaAgent extends Agent {
	...
	public void updateCatalogue(String nombre, String tipo, String precio, String elementosDisponibles) {
		addBehaviour(new OneShotBehaviour() {
			public void action() {
				...
				alibabaDb.setProductos(nombre, tipo, precio, elementosDisponibles);
	...
	class Reporte extends OneShotBehaviour{
		...
		public void action() {
			...
			//System.out.println(alibabaDB.getProdutos());
			String cadena=alibabaDB.getProdutos();
