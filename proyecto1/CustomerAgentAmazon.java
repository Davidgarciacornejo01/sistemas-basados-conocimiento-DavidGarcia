...
public class CustomerAgentAmazon extends Agent {
			...
			case 3:      
				...
				if (reply != null) {
					...
					if (reply.getPerformative() == ACLMessage.INFORM) {
						...
						String[] arrayElementos = amazonDB.buscarProducto(targetBookTitle);
						int numeroElementos=Integer.parseInt(arrayElementos[4])-1;
						amazonDB.updateProductos(numeroElementos, arrayElementos[0], arrayElementos[2]);
